...
public class PublicChatController {
  ...
  @Autowired private TextMessageRepo textMessageRepo;

  @Autowired private UserRepo userRepo;

  /**
   * Handles a new user joining the chat. message.state == CONNECTED
   *
  ...
  /**
   * Broadcasts incoming message to subscribers of /topic/public. message.state == CHAT
   *
  ...
  public TextMessage sendMessage(
      @DestinationVariable String channel, @Payload TextMessage message) {
